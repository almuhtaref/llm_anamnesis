...
> **Warning**: Этот инструмент является симулятором сбора медицинского анамнеза. Он **НЕ** ставит диагнозы, **НЕ** назначает лечение и **НЕ** заменяет врача.
...
1. Вы скармливаете ChatGPT, Claude или Deepseek промпт.
